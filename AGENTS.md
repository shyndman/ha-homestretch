...
- **Domain:** `homestretch`
- **Title:** Homestretch
- **Repository:** shyndman/ha-homestretch

**Key directories:**

- `custom_components/homestretch/` - Main integration code
...
- Integration logs: `custom_components.homestretch: debug` in `config/configuration.yaml`
...
- **Domain:** `homestretch`
- **Title:** Homestretch
- **Class prefix:** `Homestretch`

**When creating new files:**

- Use the domain `homestretch` for all DOMAIN references
- Prefix all integration-specific classes with `Homestretch`
- Use "Homestretch" as the display title
...
- Inherit from platform base + `HomestretchEntity`
...
- `tests/` mirrors `custom_components/homestretch/` structure

# Getting Started with Homestretch

This guide will help you install and set up the Homestretch custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/shyndman/ha-homestretch`
6. Set category to "Integration"
7. Click "Add"
8. Find "Homestretch" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/shyndman/ha-homestretch/releases)
2. Extract the `homestretch` folder from the archive
3. Copy it to `custom_components/homestretch/` in your Home Assistant configuration directory
...
4. Select entities from "Homestretch"
...
- Report issues at [GitHub Issues](https://github.com/shyndman/ha-homestretch/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/shyndman/ha-homestretch/discussions)

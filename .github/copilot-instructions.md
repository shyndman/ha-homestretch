...
- **Main code:** `custom_components/homestretch/`
...
- `entity/` — Base entity class (`HomestretchEntity`)
...
- Entity MRO: `(PlatformEntity, HomestretchEntity)` — order matters
...
- Debug level: `custom_components.homestretch: debug` in `config/configuration.yaml`

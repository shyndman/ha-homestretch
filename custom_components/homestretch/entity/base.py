"""
Base entity class for homestretch.
...
from custom_components.homestretch.const import ATTRIBUTION
...
class HomestretchEntity(CoordinatorEntity[HomestretchDataUpdateCoordinator]):
    """
    Base entity class for homestretch.

"""
Custom integration to integrate homestretch with Home Assistant.
...
https://github.com/shyndman/ha-homestretch
...
from .data import HomestretchData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import HomestretchConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = HomestretchData(
        client=client,

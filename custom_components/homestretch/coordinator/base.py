...
from custom_components.homestretch.api import HomestretchApiClientAuthenticationError, HomestretchApiClientError
...
class HomestretchDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> Any:
        ...
        except HomestretchApiClientAuthenticationError as exception:

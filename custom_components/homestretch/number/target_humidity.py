"""Target humidity number for homestretch."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.homestretch.api import HomestretchApiClientError
from custom_components.homestretch.const import LOGGER
from custom_components.homestretch.entity import HomestretchEntity
from homeassistant.components.number import NumberDeviceClass, NumberEntity, NumberEntityDescription, NumberMode
from homeassistant.const import PERCENTAGE
from homeassistant.exceptions import HomeAssistantError

if TYPE_CHECKING:
    from custom_components.homestretch.coordinator import HomestretchDataUpdateCoordinator
...
class HomestretchHumidityNumber(NumberEntity, HomestretchEntity):
    ...
    async def async_set_native_value(self, value: float) -> None:
        ...
        except HomestretchApiClientError as exception:
            LOGGER.exception("Failed to set target humidity")
            raise HomeAssistantError(
                translation_domain="homestretch",

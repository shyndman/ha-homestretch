...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/shyndman/ha-homestretch?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=shyndman&repository=ha-homestretch&category=integration)
...
1. Download the `custom_components/homestretch/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=homestretch)
...
Find all entities in **Settings** → **Devices & Services** → **Homestretch** → click on the device.
...
```yaml
service: homestretch.example_action
data:
  # Add your parameters here
```

### `homestretch.reload_data`
...
```yaml
service: homestretch.reload_data
```
...
logger:
  default: info
  logs:
    custom_components.homestretch: debug
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Homestretch → 3 dots → Download diagnostics)
...
[user_profile]: https://github.com/shyndman

<!-- Optional badge definitions - uncomment if needed:
[buymecoffee]: https://www.buymeacoffee.com/shyndman
